...
#define IOCTL_WINIO_MAPPHYSTOLIN  CTL_CODE(40000, 0x807, METHOD_BUFFERED, FILE_ANY_ACCESS) //-1673519076
#define IOCTL_WINIO_UNMAPPHYSADDR CTL_CODE(40000, 0x808, METHOD_BUFFERED, FILE_ANY_ACCESS) //-1673519072
